...
ReviewedCharacter.create!({character_id: Character.first.id, user_id: example_user.id, response_correct: false})
ReviewedCharacter.create!({character_id: Character.all[2].id, user_id: example_user.id, response_correct: true})
ReviewedCharacter.create!({character_id: Character.all[9].id, user_id: example_user.id, response_correct: false})
ReviewedCharacter.create!({character_id: Character.all[8].id, user_id: example_user.id, response_correct: false})
ReviewedCharacter.create!({character_id: Character.all[7].id, user_id: example_user.id, response_correct: true})
ReviewedCharacter.create!({character_id: Character.all[6].id, user_id: example_user.id, response_correct: true})
...
ReviewedCharacter.create!({character_id: Character.all[3].id, user_id: example_user.id, response_correct: true})
ReviewedCharacter.create!({character_id: Character.all[2].id, user_id: example_user.id, response_correct: false})
ReviewedCharacter.create!({character_id: Character.all[1].id, user_id: example_user.id, response_correct: true})
ReviewedCharacter.create!({character_id: Character.all[0].id, user_id: example_user.id, response_correct: false})
